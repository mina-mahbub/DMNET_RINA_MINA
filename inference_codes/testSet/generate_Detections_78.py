...
area_thresh_all = {"BF-C2DL-MuSC": [0, 100],
                   ...
                   "Cell-Data": [3300,0.99, 0.5],    #[3300,0.99,0.5]
                   "Cell-Data-P1": [800, 0.99, 0.5], # [1200, 0.7, 0.1] #[800, 0.99, 0.5]
                   "Cell-Data-P2": [6600, 0.99, 0.5],  # Area threshold, marker threshold, mask threshold # [1200, 0.7, 0.1]
                   "Cell-Data-M": [6600, 0.99, 0.5],  # [1500, 0.7, 0.3]  #[800, 0.99, 0.5]
